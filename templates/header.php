  ...
  <div class="container">
    <header class="test d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="index.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        <img src="assets/images/logoEric.png" alt="Logo Quai Antique" class="logo" >
      </a>
...
?>
  <div class="d-inline" >
    ...
    <button type="button" class="d-inline btn btn-outline-primary me-2" onclick="window.location.href ='./lib/logout.php';">Logout</button>
  </div>
<?php
  } else {
?>
